...
// Tiny click "punch" — quick scale pop for tactile feedback on click.
const punch = (el) => {
    ...
    <div className="absolute top-24 left-8 md:left-16 z-[15] max-w-[320px] pointer-events-none">
      <p
        style={{
          ...
          lineHeight: '1.6',
          textShadow: '0 0 8px rgba(255,42,42,0.4), 0 0 20px rgba(255,42,42,0.15)',
          minHeight: '2em',
        }}
      >
        "{displayed}
...
const ScrollIndicator = () => {
  ...
  return (
    <button
      onClick={handleClick}
      className="absolute bottom-32 left-1/2 -translate-x-1/2 z-[20] flex flex-col items-center gap-1 pointer-events-auto group"
      style={{ background: 'none', border: 'none', cursor: 'pointer' }}
    >
      <div className="flex flex-col items-center">
        <span className="text-white text-[9px] uppercase tracking-[3px]">
          {atBottom ? 'scroll up' : 'scroll down'}
        </span>
        <div className="w-8 h-[1px] bg-white opacity-50 mt-1"></div>
      </div>
      <span
        style={{
          display: 'inline-block',
          fontSize: '18px',
          color: 'white',
          animation: atBottom ? 'bounceUp 1.2s infinite' : 'bounceDown 1.2s infinite',
        }}
      >
        {atBottom ? '\u2191' : '\u2193'}
      </span>
        ...
        <div className="absolute bottom-0 left-0 w-full z-[10] px-8 md:px-16 pb-12 flex flex-col pointer-events-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-end w-full mb-8 max-w-[1800px] mx-auto">
            ...
            <div className="flex-1 flex flex-col items-start md:items-end gap-4">
              ...
              <div className="flex flex-col items-start md:items-end mb-2">
                <p className="text-white text-[11px] italic opacity-70 md:text-right max-w-[220px] leading-relaxed">
                  "If I'm not back in five minutes, just wait longer."
                </p>
                <div className="w-12 h-[1px] bg-[#ff2a2a] mt-2 opacity-80"></div>
              </div>
          ...
          <div className="w-full max-w-[1800px] mx-auto flex flex-col md:flex-row justify-between items-center pt-8 border-t border-[rgba(255,255,255,0.05)]">
            ...
            <div className="flex items-center space-x-12 mb-4 md:mb-0">
              {[
                { name: 'GITHUB',    url: 'https://github.com/RoronoaKarthi' },
                { name: 'LINKEDIN',  url: 'https://www.linkedin.com/in/karthikeyan-prakash' },
            ...
            <div className="text-[rgba(255,255,255,0.5)] text-[10px] uppercase tracking-[1px]">
              &copy; 2026 KARTHIK.WEB. ALL RIGHTS RESERVED.
            </div>
